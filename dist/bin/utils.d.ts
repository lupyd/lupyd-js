...
export declare function base64DecodeURL(b64urlstring: string): Uint8Array;
...
export declare namespace Utils {
    ...
    const bigintToBigEndian8Bytes: (n: bigint) => Uint8Array;
...
export declare const generateUlid: () => Uint8Array;
...
export declare const ulidFromString: (s: string) => Uint8Array;
