...
export declare namespace AuthHandler {
    ...
    function currentUser(): import("vanjs-core").State<User | null>;
    function currentUsername(): import("vanjs-core").State<string | null>;
    ...
    function getToken(forceRefresh?: boolean): Promise<string | undefined>;
    function getUsername(currentUser?: User | null): Promise<string | null>;
    ...
    function changeEmail(newEmail: string): Promise<string | null>;
}
